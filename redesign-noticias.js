    ...
    document.querySelectorAll('.sidebar').forEach(sb => {
      ...
      row.innerHTML = `
        <svg class="brand-mark" viewBox="0 0 36 36" aria-hidden="true">
          ...
          <!-- Newspaper icon -->
          <rect x="9" y="11" width="18" height="14" rx="1.2" fill="none" stroke="#0d1117" stroke-width="2"/>
          <line x1="12" y1="14.5" x2="24" y2="14.5" stroke="#0d1117" stroke-width="1.5"/>
          <line x1="12" y1="17.5" x2="24" y2="17.5" stroke="#0d1117" stroke-width="1.2"/>
          <line x1="12" y1="20" x2="18" y2="20" stroke="#0d1117" stroke-width="1.2"/>
          <line x1="12" y1="22" x2="18" y2="22" stroke="#0d1117" stroke-width="1.2"/>
          <rect x="20" y="19.5" width="4" height="3.5" fill="#0d1117"/>
        </svg>
